...
import { Power, Menu, Moon, Sun, Search, Activity, ShieldCheck } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [systemStatus, setSystemStatus] = useState<'connected' | 'initializing'>('connected');
